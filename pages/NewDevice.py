...
if os.environ['authenticated'] == 'False':
    ...
    st.warning("\U000026A0  please make sure to turn ON your device and connect it to the same wifi before adding it to the system. device can be configured via : < wifi name : 'DeviceAdmin' , password : 'adminadmin' > then head to the link : [configure device](http://192.168.4.1)")
